---
title: "Banks need to get more serious about security"
slug: banks-need-to-get-more-serious-about-security
publishDate: 22 Jun 2007
description: "There was a 'security incident' with an agent of my bank. The transaction completed last week, so now I feel free to blog about it, and then something similar happened with my credit card company..."
tags:
  - { name: "banking", slug: banking }
  - { name: "security", slug: security }
---

There was a "security incident" with an agent of (i.e. a company acting on behalf of) my bank. The transaction completed last week, so now I feel free to blog about it, and then something similar happened with my credit card company. Anyway, I've calmed down now so here's what happened....
...
Now that my re-mortgage is through, I started to buy the things I wanted for the home improvements I was doing. As part of that, I went to buy a new carpet for my lounge, hall and bedroom. I was asked to pay a deposit and the card had to be authorised over the phone with the bank. When I got home there was a message waiting for me on my voicemail to say that my card had been used in an unusual transaction and could I call my bank's fraud department.
...
<em>NOTE: This was rescued from the google cache. The original was dated Tuesday 10th January 2006.</em>
