...
Following from my previous posts ([Getting started with Spatial Data in SQL Server 2008](/2007/12/01/getting-started-with-spatial-data-in-sql-server-2008), [Spatial Data in a .NET application](/2007/12/02/spatial-data-in-a-net-application)) on the new spatial features of SQL Server 2008 I've been looking at how to get spatial data into SQL Server from a .NET application. This has not been as easy as expected.
