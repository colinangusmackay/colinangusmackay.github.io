...
<pre>&lt;div id="sizeSurchargesInfo"&gt;&lt;%-- Populated by an AJAX Callback --%&gt;&lt;/div&gt;</pre>
In hindsight, it seems rather obvious to simply comment the code. However, in these <em>enlightened</em> times it does seem unnecessarily frowned upon.
