...
<pre>git add --force &lt;filename&gt;</pre>
Replace <code>&lt;filename&gt;</code> with the file that you need to force in. This will force stage the file ready for your next commit.
