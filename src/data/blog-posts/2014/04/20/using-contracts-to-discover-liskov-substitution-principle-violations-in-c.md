...
1. Install the <a title="Code Contracts for .NET (Visual Studio plug in)" href="http://visualstudiogallery.msdn.microsoft.com/1ec7db13-3363-46c9-851f-1ce455f66970" target="_blank">Code Contracts for .NET</a> extension into Visual Studio.
...
<img class="aligncenter" src="http://static.colinmackay.co.uk/images/code-contracts/2014-04-20-visual-studio-code-contracts-properties.png" alt="Visual Studio Project Properties" width="600" />

You are now ready to see code contract issues in Visual Studio.

For more information on code contracts head over to <a href="http://research.microsoft.com/en-us/projects/contracts/" target="_blank">Microsoft Research's page on Contracts</a>.
...
<img class="aligncenter" src="http://static.colinmackay.co.uk/images/code-contracts/2014-04-20-code-contract-runtime-violation-in-unit-test.png" alt="" width="600" />
