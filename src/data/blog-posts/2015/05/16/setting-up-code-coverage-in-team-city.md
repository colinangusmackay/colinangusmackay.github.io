...
<strong>What does code coverage on a build server get you?</strong>
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-results-01.png" alt="Nightly Build Overview" />
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-results-02.png" alt="Overall Coverage Summary" />
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-results-03.png" alt="Overall Coverage Summary for Assembly" />
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-results-04.png" alt="Coverage Summary for Type" />

<em>It is worth noting that just because a line is green it does not mean it was exercised well. Code Coverage is just a metrics tool. It just says something was done, not that it was correct. This is vitally important to remember. However, it is still a valuable tool to be able to see areas where there is no code coverage at all.</em>

<strong>Setting up Code Coverage in Team City</strong>
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-01.png" alt="Team City Dashboard with Build context menu" />

On the Build Configuration Settings page, click on “Build Steps” in the side bar.

<img class=" aligncenter" src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-02.png" alt="Build Configuration Settings sidebar" />
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-03.png" alt=".NET Coverage settings" />
...
<code>+:assembly=&lt;assembly-name&gt;</code> to include an assembly, wild cards are supported.
<code>-:assembly=&lt;assembly-name&gt;</code> to exclude an assembly, wild cards are supported.
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-04.png" alt="Getting to the build report" />
...
<img src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-06.png" alt="Failure Conditions section" />

Then press “+ Add failure condition” and a dialog will pop-up.

<img class=" aligncenter" src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-07.png" alt="Add Failure Condition popup" />
...
<img class=" aligncenter" src="http://static.colinmackay.co.uk/images/team-city/2015-05-15-setup-08.png" alt="Additional Failure Conditions" />
