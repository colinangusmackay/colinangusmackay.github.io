...
If you want to use this yourself, you'll have to edit line 24 (`Assembly mvcAssembly = typeof(HomeController).Assembly;`) and provide a controller class in your project. It has also been written for [NUnit](https://www.nuget.org/packages/NUnit/), and we're using [Shouldly](https://www.nuget.org/packages/Shouldly/) as the assertion library.
